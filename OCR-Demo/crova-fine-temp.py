...
# 1. 설정
model_dir = "./donut-synthdog-ko"  # 학습된 모델이 저장된 경로
task_prompt = "<s_synthdog-ko>"  # 학습 시 사용한 task prompt
max_length = 768
...
image = sample["image"]
# image = Image.open("F:/image/receipt/r (8).jpg")
# image = Image.open("F:/image/receipt/online/3.png")
